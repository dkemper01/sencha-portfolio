/**
 * @class splitViewPortfolio.controller.Main
 ...
 */
Ext.define('splitViewPortfolio.controller.Main', {
    ...
    /**
     * @private
     * In the SplitView portfolio app we could have a large number of dynamic views. If we were to keep all of them
     * rendered, we'd risk causing the browser to run out of memory, especially on older devices. If we destroy them as
     ...
     * used in a while.
     * @param {String} name The full class name of the view to create (e.g. "splitViewPortfolio.view.Forms")
