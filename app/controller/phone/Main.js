/**
 * @class splitViewPortfolio.controller.phone.Main
 * @extends splitViewPortfolio.controller.Main
 *
 * This is the Main controller subclass for the 'phone' profile. Most of the functionality required for this controller
 * is provided by the splitViewPortfolio.controller.Main superclass, but we do need to add a couple of refs and control
 ...
 *
 */
Ext.define('splitViewPortfolio.controller.phone.Main', {
    extend: 'splitViewPortfolio.controller.Main',
    ...
    /**
     * For a given App model instance, shows the appropriate view. This is the endpoint for all routes matching
     * 'demo/:id', so is called automatically whenever the user navigates back or forward between demos.
     * @param {Portfolio.SplitView.model.App} item The App model instance for which we want to show a view
     */
