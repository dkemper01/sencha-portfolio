/**
 * @class splitViewPortfoliocontroller.tablet.Main
 * @extends splitViewPortfoliocontroller.Main
 *
 ...
 */
Ext.define('splitViewPortfolio.controller.tablet.Main', {
     ...
     * 'app/:id', so is called automatically whenever the user navigates back or forward between apps.
     * @param {Portfolio.SplitView.model.Apps} item The App model instance for which we want to show a view
     */
