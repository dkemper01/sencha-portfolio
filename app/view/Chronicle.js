...
Ext.define('splitViewPortfolio.view.Chronicle', {
        ...
        items: [
            {
                ...
                iconCls: 'photos',
                xtype: 'container',
                itemId: 'ext-container-screenshots-three',
                ...
                items: [
                    {
                        xtype: 'panel',
                        cls: 'card',
                        html: '<div>Maximize your efficiency by understanding how you really work.</div>',
                    ...
                    },
                    {
                        ...
                        */
                        ...
                        store: {
                            fields: ['screenShot'],
                            data: [
                                {screenShot: 'resources/images/sample-app-medium-2.png'},
            ...
            },
            {
                ...
                html: '<div class="app-details-panel"><p>Chronicle keeps track of your time so you don\'t have to!</p><ol><li>The most accurate tracking application on the market.</em></li><li>Configure your tasks for the day and go!  Set it and forget it.</li><li>Adjust any time-span or detail on any task in the timeline.  Mistakes are allowed!</li></ol><p>Cloud-based solution provides you:</p><ol><li>100% up-time.</li><li>Mobile and desktop options.</li><li>Highly competitive pricing per-seat.</li></ol></div>',
                iconCls: 'info',
    ...
    handleOrientationChange: function(component, orientation, width, height) {
        ...
        var screenShotsContainer = component.down('#ext-container-screenshots-three');
